...
q2_translations <- list(
  ...
  portuguese = c(
    ...
    "Eu deixo de tomar 1 vez por semana" = "Sometimes I forget (less than once a week)",
    "Eu deixo de tomar várias vezes por semana" = "Sometimes I forget (more than once a week)",
  ...
  french = c(
    ...
    "Je ne prends pas mon traitement parfois (moins d'une fois par semaine)" = "Sometimes I forget (less than once a week)",
    "Je ne prends pas mon traitement souvent (plus d'une fois par semaine)" = "Sometimes I forget (more than once a week)",
...
q3_translations <- list(
  ...
  portuguese = c(
    "Porque me esqueço" = "I forget",
    "Porque não confio nestes medicamentos" = "I don't trust these medicines",
    "Porque acho que não preciso deles" = "I don't think I need them",
    "Porque acho que me fazem piorar" = "I think they make me worse",
  ...
  french = c(
    ...
    "Ils coûtent trop chers" = "They cost too much",
...
write_csv(all_data, "data/processedharmonized_survey_data.csv")
...
# Save plot
#ggsave("intervention_preferences.png", intervention_plot, width = 10, height = 6)
...
write_csv(english_harmonized, "data/processed/english_harmonized.csv")
write_csv(italian_harmonized, "data/processed/italian_harmonized.csv")
write_csv(portuguese_harmonized, "data/processed/portuguese_harmonized.csv")
write_csv(french_harmonized, "data/processed/french_harmonized.csv")
