...
write.csv(english_data, "english_data.csv", row.names = FALSE)
write.csv(italian_data, "italian_data.csv", row.names = FALSE)
write.csv(portuguese_data, "portuguese_data.csv", row.names = FALSE)
write.csv(french_data, "french_data.csv", row.names = FALSE)

# Read the CSV files with proper column type specifications
french_data <- read_csv("french_data.csv", 
                       col_types = cols(.default = col_character()))
italian_data <- read_csv("italian_data.csv", 
                        col_types = cols(.default = col_character()))
portuguese_data <- read_csv("portuguese_data.csv", 
                           col_types = cols(.default = col_character()))
english_data <- read_csv("english_data.csv", 
                        col_types = cols(.default = col_character()))
